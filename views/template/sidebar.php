        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>Laundry Warohmah!</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">                  
                  ...
                  <li><a href="../transaksi/v_registrasi_pelanggan.php"><i class="fa fa-group"></i> Registrasi Pelanggan <span class="label label-success pull-right"></span></a></li>
